...
let components: QmlComponent [] = json.components;
...
function isValidComponent (str: string): boolean {
...
function addComponenetAttributes (component: QmlComponent, items: CompletionItem[]) {
